...
(function() {
    ...
    const shortcuts = {
        ...
        searchCtrl: { key: 'k', ctrl: true, alt: false, description: 'Focus search (Ctrl+K)' },
        home: { key: 'h', ctrl: false, alt: false, description: 'Go to home' },
        categories: { key: 'c', ctrl: false, alt: false, description: 'Browse categories' },
        randomPrompt: { key: 'r', ctrl: false, alt: false, description: 'Random prompt' },
        toggleTheme: { key: 't', ctrl: false, alt: false, description: 'Toggle dark mode' },
        help: { key: '?', ctrl: false, alt: false, description: 'Show help' },
        copy: { key: 'c', ctrl: true, alt: false, description: 'Copy current prompt' },
        bookmark: { key: 'b', ctrl: false, alt: false, description: 'Bookmark current prompt' },
        share: { key: 's', ctrl: false, alt: false, description: 'Share current prompt' },
        nextPage: { key: 'ArrowRight', ctrl: false, alt: false, description: 'Next page' },
        prevPage: { key: 'ArrowLeft', ctrl: false, alt: false, description: 'Previous page' },
        escape: { key: 'Escape', ctrl: false, alt: false, description: 'Close overlays' }
    };
    ...
    function focusSearch() {
        const searchInput = document.querySelector('#searchInput, #searchPageInput, .search-input');
        if (searchInput) {
            searchInput.focus();
            searchInput.select();
    ...
    function copyCurrentPrompt() {
        const promptContent = document.querySelector('.prompt-content, .code-container pre');
        if (promptContent) {
    ...
    function navigateToNextPage() {
        const nextButton = document.querySelector('.pagination-btn:contains("Next"), .next-prompt, [aria-label="Next"]');
        if (nextButton) {
            nextButton.click();
        } else {
    ...
    function navigateToPreviousPage() {
        const prevButton = document.querySelector('.pagination-btn:contains("Previous"), .prev-prompt, [aria-label="Previous"]');
        if (prevButton) {
            prevButton.click();
        } else {
    ...
    function initAdvancedShortcuts() {
        ...
        document.addEventListener('keydown', (e) => {
            ...
            if (e.key >= '1' && e.key <= '9' && !e.ctrlKey && !e.altKey) {
                ...
                const categoryLinks = document.querySelectorAll('.category-link, .category-card a');
