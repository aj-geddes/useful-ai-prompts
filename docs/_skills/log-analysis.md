...
date: '2025-01-01'
description: Analyze application and system logs to identify errors, patterns, and
  root causes. Use log aggregation tools and structured logging for effective debugging.
layout: skill
slug: log-analysis
tags:
- development
