...
date: '2025-01-01'
description: Secure REST APIs with authentication, rate limiting, CORS, input validation,
  and security middleware. Use when building or hardening API endpoints against common
  attacks.
layout: skill
