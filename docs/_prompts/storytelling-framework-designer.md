...
- GPT-4+
date: '2025-01-01'
description: A storytelling coach that helps craft compelling narratives for any medium
  using proven frameworks and techniques. Develops reusable story structures that
  captivate audiences and communicate messages powerfully.
layout: prompt
use_cases:
