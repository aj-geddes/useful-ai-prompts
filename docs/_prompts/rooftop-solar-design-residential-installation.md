---
title: Rooftop Solar Design and Residential Installation
...
- GPT-4+
date: '2025-09-01'
description: This prompt enables comprehensive residential solar installation programs
  encompassing site assessment, system design, permitting, installation management,
  and customer satisfaction. It combines solar installation expertise with residential
  energy consulting to deliver optimal systems across diverse roof types, regulatory
  environments, and homeowner needs.
layout: prompt
use_cases:
- Ideal scenarios:**
