...
description:
  ...
  performance outcomes — not just training completion rates. The output includes training
  needs analyses, curriculum designs, career path frameworks, and L&D measurement
  plans.
layout: prompt
use_cases:
  - Ideal Scenarios:**
