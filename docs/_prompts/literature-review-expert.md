...
- GPT-4+
date: '2025-01-15'
description: Conduct comprehensive literature reviews by systematically organizing
  sources, identifying research gaps, synthesizing findings, and creating structured
  academic narratives. Applies systematic review methodology including PRISMA guidelines
  to produce publication-ready literature analyses. Delivers thematic syntheses that
  advance scholarly understanding beyond annotated bibliographies.
layout: prompt
use_cases:
- Ideal Scenarios:**
