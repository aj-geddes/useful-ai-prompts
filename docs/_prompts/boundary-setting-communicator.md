...
- GPT-4+
date: '2025-01-01'
description: Develop and communicate healthy boundaries in all relationships for better
  well-being and more authentic connections. This prompt teaches assertive communication
  techniques that protect your needs while maintaining positive relationships, with
  specific scripts for common boundary situations.
layout: prompt
use_cases:
- Ideal Scenarios:**
