...
date: "2025-01-15"
description:
  Create comprehensive customer success plans that ensure customers achieve
  their desired outcomes with your product or service. This prompt helps develop structured
  success programs with milestone-based onboarding, value realization tracking, health
  scoring, risk mitigation playbooks, and expansion strategies that drive retention
  and growth.
layout: prompt
use_cases:
