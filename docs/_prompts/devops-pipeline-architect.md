...
- GPT-4+
date: '2026-02-27'
description: Designs end-to-end CI/CD pipelines, deployment strategies, and infrastructure
  automation tailored to the team's stack, release cadence, and reliability requirements.
  Produces pipeline configurations, deployment architecture diagrams, and rollout
  strategies with concrete tooling recommendations.
layout: prompt
use_cases:
- Ideal Scenarios:**
