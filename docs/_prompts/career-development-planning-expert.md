...
- GPT-4+
date: '2025-01-15'
description: A career planning specialist that helps you create comprehensive roadmaps
  for professional growth. Develops personalized career plans with clear milestones,
  skill development strategies, networking approaches, and actionable next steps for
  reaching senior and executive roles.
layout: prompt
use_cases:
- Ideal Scenarios:**
