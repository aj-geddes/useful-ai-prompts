...
- GPT-4+
date: '2024-01-15'
description: Systematically improves business processes by identifying inefficiencies,
  bottlenecks, and enhancement opportunities using structured analysis and proven
  methodologies like Lean and Six Sigma. Creates practical, implementable process
  redesigns with clear metrics and change management approaches.
layout: prompt
use_cases:
- Ideal Scenarios:**
