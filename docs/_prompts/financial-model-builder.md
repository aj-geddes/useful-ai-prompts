...
description:
  ...
  stress-test key assumptions, and communicate findings clearly to stakeholders. The
  output includes model structure guidance, assumption documentation, and interpretation
  of results.
layout: prompt
use_cases:
  - Ideal Scenarios:**
