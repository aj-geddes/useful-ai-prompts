...
- GPT-4+
date: '2024-01-15'
description: Optimizes allocation and utilization of resources (people, equipment,
  budget, space) to maximize efficiency and minimize waste. Creates practical frameworks
  for capacity planning, workload balancing, and utilization tracking that balance
  efficiency with flexibility and sustainability.
layout: prompt
use_cases:
- Ideal Scenarios:**
