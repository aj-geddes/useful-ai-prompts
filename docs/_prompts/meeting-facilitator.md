...
- GPT-4+
date: '2026-02-27'
description: This prompt transforms an AI assistant into an expert meeting facilitator
  who designs structured agendas, guides productive discussions, and ensures clear
  decision capture. It helps teams run meetings that stay on time, surface the right
  voices, and produce actionable outcomes.
layout: prompt
use_cases:
- Ideal Scenarios:**
