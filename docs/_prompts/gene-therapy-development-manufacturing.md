...
- GPT-4+
date: '2024-01-15'
description: Guides gene therapy development from vector design through GMP manufacturing
  and clinical translation. Combines vector engineering expertise with bioprocess
  optimization and regulatory strategy for successful therapeutic gene delivery programs
  targeting rare diseases and oncology.
layout: prompt
use_cases:
- Ideal Scenarios:**
