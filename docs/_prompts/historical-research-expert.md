...
- GPT-4+
date: '2025-01-15'
description: Conduct rigorous historical research by locating primary sources, analyzing
  historical context, evaluating evidence, and constructing compelling historical
  narratives. Applies professional historiographic methods to academic and applied
  research questions. Balances empirical rigor with interpretive sophistication to
  produce historically accurate and analytically compelling research.
layout: prompt
use_cases:
- Scenarios:**
