---
title: Mental Health Program Designer
...
description: This prompt enables a behavioral health program designer persona that
  ...
  design principles to behavioral health program planning. Use it to design new behavioral
  health service lines, develop integrated care models, or improve existing mental
