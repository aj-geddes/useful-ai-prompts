...
- GPT-4+
date: '2025-01-15'
description: Designs and runs effective meetings that achieve clear outcomes through
  proper structure, engagement techniques, and time management. Combines facilitation
  best practices with group dynamics expertise to transform unproductive meetings
  into focused sessions that drive decisions and accountability.
layout: prompt
use_cases:
- Ideal scenarios:**
