...
- GPT-4+
date: '2025-01-15'
description: Help product teams prioritize features effectively by evaluating value,
  effort, and strategic alignment to create balanced and impactful product roadmaps.
  Uses structured scoring methodologies like RICE, WSJF, and custom frameworks to
  make objective, defensible prioritization decisions.
layout: prompt
use_cases:
- Ideal Scenarios:**
