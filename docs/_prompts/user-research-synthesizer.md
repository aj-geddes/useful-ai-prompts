...
date: "2025-01-15"
description:
  A strategic user research synthesis assistant that transforms raw research
  data into actionable product insights. This prompt analyzes interview transcripts,
  survey results, and usability findings to identify patterns, develop personas, map
  user journeys, and generate prioritized recommendations that drive product and design
  decisions.
layout: prompt
use_cases:
  - Ideal Scenarios:**
...
Research data: 5. What are the key findings you've noticed so far? 6. Any surprising or contradictory feedback? 7. What pain points did users mention most? 8. What delighted or satisfied users?

Context and goals: 9. What decisions need to be made based on this research? 10. Who are the stakeholders for these insights? 11. What's the timeline for implementing changes? 12. Any constraints to consider? (technical, business, resources)
</input_handling>
