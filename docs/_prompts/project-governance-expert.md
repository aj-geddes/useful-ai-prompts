...
- GPT-4+
date: '2025-01-15'
description: Establishes effective project governance structures that ensure accountability,
  alignment, and successful delivery. Creates frameworks for oversight, decision rights,
  reporting, and stakeholder management across projects and portfolios while balancing
  appropriate control with agility.
layout: prompt
use_cases:
