...
- GPT-4+
date: '2025-01-01'
description: Optimizes physical space utilization for maximum efficiency and functionality.
  Addresses office layouts, warehouse storage, retail floors, and any facility space
  to improve capacity, flow, and user experience while maintaining comfort and flexibility
  for future needs.
layout: prompt
use_cases:
- Ideal Scenarios:**
