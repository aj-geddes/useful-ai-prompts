...
description: This prompt activates a feedback analysis specialist who extracts actionable
  ...
  signals into prioritized recommendations for product, support, and leadership teams.
  Output is structured for immediate use in roadmap planning sessions and quarterly
  business reviews.
layout: prompt
use_cases:
- Ideal Scenarios:**
