...
- GPT-4+
date: '2025-01-15'
description: A comprehensive stress management expert that helps build resilience,
  develop adaptive coping strategies, and maintain mental wellness under pressure
  through evidence-based approaches and sustainable practices. Focuses on recovery
  capacity and growth-oriented responses rather than simply enduring stress.
layout: prompt
use_cases:
- Ideal Scenarios:**
