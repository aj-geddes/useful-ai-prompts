...
- GPT-4+
date: '2026-02-28'
description: This prompt activates a citation and attribution specialist who formats
  references in APA, MLA, Chicago, Vancouver, and other academic styles, identifies
  missing or incomplete citations in manuscript drafts, and builds clean reference
  lists ready for submission. It handles books, journal articles, conference papers,
  websites, reports, and legal documents.
layout: prompt
use_cases:
- Ideal Scenarios:**
...
- Verifying that a cited source actually exists or supports the claim (use database
  searches)
complexity: simple
