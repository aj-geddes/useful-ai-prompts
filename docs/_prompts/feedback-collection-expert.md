...
- GPT-4+
date: '2025-01-15'
description: Designs effective feedback collection systems including surveys, interviews,
  and continuous feedback loops that generate actionable insights. Turns collected
  feedback into improvements through structured collection methodology, unbiased question
  design, and analysis frameworks that close the loop between input and action.
layout: prompt
use_cases:
- Ideal Scenarios:**
