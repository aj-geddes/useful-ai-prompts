...
**Don't use for**: Statistical analysis methods, scientific experiment design, data science research
...
- Priority: Organization framework that captures and categorizes insights
...
Search technique matrix:
| Information Need | Primary Sources | Search Approach |
|-----------------|-----------------|-----------------|
| Competitor positioning | Websites, press releases | Document messaging, value propositions |
| Market size/trends | Industry reports, analyst coverage | Paid databases + free summaries |
| Customer pain points | Reviews, forums, social | Keyword monitoring, sentiment analysis |
| Pricing intelligence | Competitor sites, sales calls | Direct observation, mystery shopping |

Tools: Set up Google Alerts for competitor names, use Feedly for industry publications, create Twitter lists for industry analysts
...
- Aggregated review data (multiple platforms, large sample)
...
- Insights table: Key finding, source link, category, confidence level
- Competitor profiles: One page per competitor with linked insights
- Trend tracking: Time-stamped observations with source references
```
